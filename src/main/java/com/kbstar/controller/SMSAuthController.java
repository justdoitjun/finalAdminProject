...
public class SMSAuthController {
    ...
    public SMSAuthController() {
        // 반드시 계정 내 등록된 유효한 API 키, API Secret Key를 입력해주셔야 합니다!
        this.messageService = NurigoApp.INSTANCE.initialize("NCSVQFXQFGQYKSPW", "OEALUZWYC4IHK3GQMCNUBZAWCQO4AV6B", "https://api.coolsms.co.kr");
    }
